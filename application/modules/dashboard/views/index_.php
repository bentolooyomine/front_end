...
<!-- Mirrored from jdih.batangkab.go.id/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Mar 2026 21:51:32 GMT -->
...
<head>
    ...
    <script>
        // const api_key = 'ZGhSdSt6U2NnQ3pvRXZWK2dUOTZLekkrZ0NHcngwOEZGcjNsZW9EZXpyaz0=';
                    ...
                    <div class="horizontal-mainwrapper container clearfix">
                        ...
                        <div class="desktoplogo-1">
                            <a href="<?= base_url('assets/')?>index.html" class="d-flex">
                                ...
                                <!-- <img src="<?= base_url('assets/')?>https://jdih.batangkab.go.id/src/back/img/logo-batang.png" class="img-responsive" width="50" height="60" style="padding-bottom:7px;">
                                <h2 class="font-weight-bold mb-0 fs-30 text-dark mt-1">JDIH Kabupaten Blora</h2> -->
                            </a>
                        </div>
                        <nav class="horizontalMenu clearfix d-md-flex" style="height: 739px;">
                            <ul class="horizontalMenu-list">
                                                                    <li>
                                                                                    ...
                                                                                    <a href="<?= base_url('assets/')?>index.html">Beranda</a>
                                                ...
                                                <i class="horizontalMenu-arrow fa fa-angle-down"></i>
                                                                                    ...
                                                                                    <a href="<?= base_url('assets/')?>#">Tentang Kami <span class="fa fa-caret-down m-0"></span></a>
                                        
                                                                                    <ul class="sub-menu">
                                                                                                    <li><a href="<?= base_url('assets/')?>page/visi-misi.html">Visi Misi</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/tugas-pokok-fungsi-dan-program-kerja.html">Tugas Pokok, Fungsi dan Program Kerja</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/hubungi-kami.html">Hubungi Kami</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/anggota-jdih.html">Anggota JDIH</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/sop-jdih.html">SOP</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/struktur-organisasi.html">Tim Pengelola</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/struktur-organisasi-jdih.html">Struktur Organisasi</a></li>
                                                                                            </ul>
                                                                            </li>
                                                                    <li>
                                        
                                                                                    <a href="<?= base_url('assets/')?>page/produk-hukum-desa.html">Produk Hukum Desa </a>
                                                ...
                                                <i class="horizontalMenu-arrow fa fa-angle-down"></i>
                                                                                    ...
                                                                                    <a href="<?= base_url('assets/')?>#">Peraturan <span class="fa fa-caret-down m-0"></span></a>
                                        
                                                                                    <ul class="sub-menu">
                                                                                                    <li><a href="<?= base_url('assets/')?>page/peraturan-daerah.html">Peraturan Daerah</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/peraturan-bupati.html">Peraturan Bupati</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/keputusan-bupati.html">Keputusan Bupati</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/instruksi-bupati.html">Instruksi Bupati</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/staatsblad.html">Staatsblad</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/peraturan-terjemahan-resmi.html">Peraturan Terjemahan Resmi</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/koleksi-braile.html">Koleksi Braile</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/mou-dan-pks.html">MOU dan PKS</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/surat-edaran-bupati.html">Surat Edaran Bupati</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/surat-edaran-sekda.html">Surat Edaran Sekda</a></li>
                                                                                            </ul>
                                                                            </li>
                                                                    <li>
                                                                                    <span class="horizontalMenu-click">
                                                <i class="horizontalMenu-arrow fa fa-angle-down"></i>
                                                                                    ...
                                                                                    <a href="<?= base_url('assets/')?>#">Dokumen Pembentukan PUU <span class="fa fa-caret-down m-0"></span></a>
                                        
                                                                                    <ul class="sub-menu">
                                                                                                    <li><a href="<?= base_url('assets/')?>page/program-penyusunan-peraturan-perundang-undangan.html">Program Penyusunan PUU</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/rancangan-peraturan-daerah.html">Rancangan Peraturan Daerah</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/rancangan-peraturan-bupati.html">Rancangan Peraturan Bupati</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/naskah-akademis.html">Naskah Akademis</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/analisis-dan-evaluasi-hukum.html">Analisis Dan Evaluasi Hukum</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/kajian-hukum.html">Kajian Hukum</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/risalah-pembahasan.html">Risalah Pembahasan</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/buku-hukum.html">Buku Hukum</a></li>
                                                                                            </ul>
                                                                            </li>
                                                                    <li>
                                        
                                                                                    <a href="<?= base_url('assets/')?>page/putusan.html">Putusan </a>
                                                ...
                                                <i class="horizontalMenu-arrow fa fa-angle-down"></i>
                                                                                    ...
                                                                                    <a href="<?= base_url('assets/')?>#">Informasi <span class="fa fa-caret-down m-0"></span></a>
                                        
                                                                                    <ul class="sub-menu">
                                                                                                    <li><a href="<?= base_url('assets/')?>page/video.html">Video</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/galeri-kegiatan.html">Galeri Kegiatan</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/statistik.html">Statistik</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/berita.html">Berita</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/artikel-hukum.html">Artikel Hukum</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/pengumuman.html">Pengumuman</a></li>
                                                                                            </ul>
                                                                            </li>
                                                                    <li>
                                                                                    <span class="horizontalMenu-click">
                                                <i class="horizontalMenu-arrow fa fa-angle-down"></i>
                                                                                    ...
                                                                                    <a href="<?= base_url('assets/')?>#">Download <span class="fa fa-caret-down m-0"></span></a>
                                        
                                                                                    <ul class="sub-menu">
                                                                                                    <li><a href="<?= base_url('assets/')?>page/dokumen.html">Dokumen</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/katalog-perda.html">Katalog Perda</a></li>
                                                                                                    <li><a href="<?= base_url('assets/')?>page/katalog-perbup.html">Katalog Perbup</a></li>
                                                                                            </ul>
                                                                            </li>
                                                            </ul>
                            <ul class="mb-0 pr-2">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
	...
	<script>(function(d){var s = d.createElement("script");s.setAttribute("data-account", "yNIGOrk4xM");s.setAttribute("src", "//accessibilityserver.org/widget.js");(d.body || d.head).appendChild(s);})(document)</script><noscript>Please ensure Javascript is enabled for purposes of <a href="<?= base_url('assets/')?>https://accessibilityserver.org/">website accessibility</a></noscript>
</body>
