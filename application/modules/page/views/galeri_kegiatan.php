    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card">
    <div class="card-body">
                <div style="margin-right:80px;"><p><strong><?= $nama_modul?></strong></p>
    ...
    <div class="col-md-12">
        <div class="card shadow border-0">
            <div class="card-body bg-danger text-white text-center">
                <h2>🎬 <?= $nama_modul ?></h2>
                <small>Kumpulan Video Informasi & Dokumentasi</small>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <div class="card gallery-card shadow-sm border-0">
            ...
            <div class="gallery-img-wrapper">
                <a href="<?= base_url('assets/uploads/'.$g->link_file) ?>" 
                   class="glightbox" 
                   data-gallery="gallery1"
                   data-title="<?= $g->judul ?>"
                   data-description="<?= $g->deskripsi ?>">
                   
                    <img src="<?= base_url('assets/uploads/'.$g->link_file) ?>" 
            ...
            <div class="card-body">
                ...
                <small class="text-muted"><?= $g->deskripsi ?></small>
            </div>
        </div>
    </div>
<?php endforeach; ?>
