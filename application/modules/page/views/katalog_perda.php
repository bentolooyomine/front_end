...
<div class="container">
    ...
    <div class="text-center mb-4">
        <h3 class="fw-bold"><?= $nama_modul ?></h3>
        <small class="text-muted">Kumpulan Dokumen Peraturan Daerah</small>
    </div>
    ...
    <?php foreach($gambar as $p): ?>
        <div class="col-md-3 col-sm-6 mb-4">
            <div class="card perda-card h-100 border-0">
    ...
    <?= $p->status == 'aktif' ? '✔ Aktif' : '✖ Tidak Aktif' ?>
                ...
                <div class="card-footer bg-transparent border-0 text-center pb-3">
                    <a href="<?= base_url('assets/uploads/perda/'.$p->file) ?>" 
                       target="_blank"
